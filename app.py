...
# df_1 = pd.read_csv("data/WA_Fn-UseC_-Telco-Customer-Churn.csv")
#
# q = ""
#
#
...
#     new_df__dummies.columns = map(str.lower, new_df__dummies.columns)
#
#     new_df__dummies.columns = [col.title().replace('_', ' ') for col in new_df__dummies.columns]
#
